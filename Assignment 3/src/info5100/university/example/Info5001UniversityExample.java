...
private static void createCourseOffers(CourseSchedule courseSchedule) {
    ...
    private static void createFacultyProfiles(PersonDirectory personDirectory, 
        ...
        courseFacultyMap.put("INFO 6206", "Emily");
        courseFacultyMap.put("INFO 6205", "David");
        courseFacultyMap.put("INFO 5100", "Sophia");
        courseFacultyMap.put("INFO 5101", "James");
        courseFacultyMap.put("INFO 6203", "Oliver");
        courseFacultyMap.put("INFO 5104", "Amelia");
        courseFacultyMap.put("INFO 5105", "William");
        courseFacultyMap.put("INFO 5200", "Charlotte");
        courseFacultyMap.put("INFO 5300", "Lucas");
        courseFacultyMap.put("INFO 6105", "Isabella");
        courseFacultyMap.put("INFO 7100", "Liam");
